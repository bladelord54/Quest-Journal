 ...
 *     level-3 gate, and the balance-sourced locked-companion gold table).
 ...
 *     attaches to window.LOOT_ENGINE. goal-manager.js captures it into a
 *     module-scoped const and delegates from the loot methods.
...
(function () {
    ...
    // dynamic LOOT_ENGINE property on the global object.
    const root = /** @type {any} */ (
        typeof window !== 'undefined' ? window
        : (typeof globalThis !== 'undefined' ? globalThis : null)
    );
    if (root) root.LOOT_ENGINE = LOOT_ENGINE;

    // Node / Jest
    if (typeof module !== 'undefined' && module.exports) module.exports = LOOT_ENGINE;
})();
