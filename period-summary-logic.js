...
(function () {
    ...
    // PERIOD_SUMMARY_LOGIC property on the global object.
    const root = /** @type {any} */ (
        typeof window !== 'undefined' ? window
        : (typeof globalThis !== 'undefined' ? globalThis : null)
    );
    if (root) root.PERIOD_SUMMARY_LOGIC = PERIOD_SUMMARY_LOGIC;

    // Node / Jest
    if (typeof module !== 'undefined' && module.exports) module.exports = PERIOD_SUMMARY_LOGIC;
})();
