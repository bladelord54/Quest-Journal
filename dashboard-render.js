...
(function () {
    ...
    // dynamic DASHBOARD_RENDER property on the global object.
    const root = /** @type {any} */ (
        typeof window !== 'undefined' ? window
        : (typeof globalThis !== 'undefined' ? globalThis : null)
    );
    if (root) root.DASHBOARD_RENDER = DASHBOARD_RENDER;

    // Node / Jest
    if (typeof module !== 'undefined' && module.exports) module.exports = DASHBOARD_RENDER;
})();
