...
(function () {
    ...
    // REMINDER_SCHEDULE_LOGIC property on the global object.
    const root = /** @type {any} */ (
        typeof window !== 'undefined' ? window
        : (typeof globalThis !== 'undefined' ? globalThis : null)
    );
    if (root) root.REMINDER_SCHEDULE_LOGIC = REMINDER_SCHEDULE_LOGIC;

    // Node / Jest
    if (typeof module !== 'undefined' && module.exports) module.exports = REMINDER_SCHEDULE_LOGIC;
})();
