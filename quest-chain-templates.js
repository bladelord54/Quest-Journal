...
(function () {
    ...
    // dynamic QUEST_CHAIN_TEMPLATES property on the global object.
    const root = /** @type {any} */ (
        typeof window !== 'undefined' ? window
        : (typeof globalThis !== 'undefined' ? globalThis : null)
    );
    if (root) root.QUEST_CHAIN_TEMPLATES = QUEST_CHAIN_TEMPLATES;

    // Node / Jest
    if (typeof module !== 'undefined' && module.exports) module.exports = QUEST_CHAIN_TEMPLATES;
})();
